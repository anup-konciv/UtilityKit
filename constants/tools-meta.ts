...
export const TOOLS: ToolMeta[] = [
  ...
  },
  {
    ...
    description: 'Log trips, budgets & destinations',
    icon: 'airplane-outline',
    route: '/tools/travel-tracker',
    accent: '#0891B2',
    badge: 'Life',
  },
  {
    ...
    description: 'Daily routines with streaks',
    icon: 'time-outline',
    route: '/tools/routine-tracker',
    accent: '#8B5CF6',
    badge: 'Life',
  },
  {
    ...
    label: 'Assignments',
    description: 'Track homework & due dates',
    icon: 'school-outline',
  ...
  },
  {
    id: 'baby-care',
    label: 'Baby Care',
    description: 'Feed, diaper, sleep & milestones',
    icon: 'heart-outline',
    route: '/tools/baby-care',
    accent: '#EC4899',
    badge: 'Life',
  },
  {
    id: 'house-bill-tracker',
    label: 'House Bills',
    description: 'Track rent, utilities & payments',
    icon: 'receipt-outline',
    route: '/tools/house-bill-tracker',
    accent: '#059669',
    badge: 'Finance',
  },
  {
    ...
    description: 'Units, cost & monthly trends',
    icon: 'flash-outline',
    route: '/tools/electricity-bill',
    accent: '#F59E0B',
    badge: 'Finance',
  },
  {
