...
export default function CookTrackerScreen() {
  ...
  useEffect(() => {
    loadJSON<CookData>(KEYS.cookTracker, {
      name: 'Cook',
      monthlySalary: 0,
      attendance: [],
      payments: [],
  ...
  const persist = useCallback((d: CookData) => {
    setData(d);
    saveJSON(KEYS.cookTracker, d);
  }, []);
  ...
  const saveSettings = () => {
    persist({ ...data, name: nameInput.trim() || 'Cook', monthlySalary: parseFloat(salaryInput) || 0 });
      ...
      <Modal visible={showSettings} transparent animationType="fade" onRequestClose={() => setShowSettings(false)}>
        <View style={styles.modalBg}>
          <View style={[styles.modalCard, { backgroundColor: colors.bg }]}>
            <Text style={[styles.modalTitle, { color: colors.text }]}>Cook Settings</Text>
            ...
            <TextInput
              ...
              value={nameInput} onChangeText={setNameInput} placeholder="Cook name" placeholderTextColor={colors.textMuted} autoFocus
            />
