...
export const KEYS = {
  ...
  expenseCustomCategories: 'uk_expense_custom_categories',
  expenseTransfers: 'uk_expense_transfers',
  ...
  subscriptionCustomCategories: 'uk_subscription_custom_categories',
